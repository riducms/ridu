...
| `RIDU_ALLOWED_ORIGINS`                  | Exact browser origins allowed to make [cross-origin requests](https://riducms.com/docs/cors/). Same-origin embedded admin traffic needs no entry.                                                                                    |
