<!-- Generated from website/src/content/docs/go-packages/schema.md by scripts/sync-agent-docs.ts. -->
...
`generated/ridu.schema.json`; see [Generated types and files](../generated-contracts.md) before
...
[schema migration](../migrations.md); changing a title on one post is a content update. The
...
[callback contexts](./operation.md) instead of parsing that token.
...
See [Filters and paths](./query.md) for the similar distinction between a valid
...
Use [Validation](../fields/validation.md) to write messages for content authors, and
[Configuration](../configuration.md) to define the application. The
[schema API reference](https://riducms.com/reference/schema/) lists the exact resolved properties when you need to
