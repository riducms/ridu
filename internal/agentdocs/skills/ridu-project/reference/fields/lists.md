<!-- Generated from website/src/content/docs/fields/lists.md by scripts/sync-agent-docs.ts. -->
...
| Several choices from a predefined set | [MultiSelect](https://riducms.com/docs/fields/select/) | `["small", "large"]`                                  |
| Several fields per item               | [Array](https://riducms.com/docs/fields/array/)        | `[{"_key":"a", "label":"Docs", "url":"/docs"}]`       |
| Different kinds of item in one list   | [Blocks](https://riducms.com/docs/fields/blocks/)      | `[{"_key":"a", "blockType":"quote", "text":"Hello"}]` |
...
[`.DefaultFrom(...)`](./defaults.md#supported-fields) with `operation.Value[[]string]`
...
reorders the list; they are not item IDs. See [custom validation](./validation.md)
...
under another field name. [Field factories](../fields.md#field-access-and-hooks) can return
...
Use `.LiveValidate(...)` for [live server feedback](./live-validation.md). The callback
...
For a [custom field component](../custom-components/field-components.md), register an editor
