...
performing other expensive work. See the [endpoint context reference](https://riducms.com/reference/core/endpoint-context/).
...
plans their migrations together with application collections. See [Migrations](./migrations.md).
