<!-- Generated from website/src/content/docs/custom-components/document-actions.md by scripts/sync-agent-docs.ts. -->

# Custom document buttons
...
Use the [generated SDK](../typescript-sdk.md) or your application's API to perform the change.
...
typing, put it inside a [field component](./field-components.md).
