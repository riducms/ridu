<!-- Generated from website/src/content/docs/custom-components/row-labels.md by scripts/sync-agent-docs.ts. -->
...
See [RowLabelProps](https://riducms.com/reference/plugin/row-label-props/) for the available component props.
