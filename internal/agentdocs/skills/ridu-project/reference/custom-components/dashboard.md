<!-- Generated from website/src/content/docs/custom-components/dashboard.md by scripts/sync-agent-docs.ts. -->
...
The [overview](../custom-components.md#first-component) shows a welcome panel. This
...
Use your [generated SDK](../typescript-sdk.md) to fetch counts, reports, or recent documents.
