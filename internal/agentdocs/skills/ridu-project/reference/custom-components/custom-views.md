<!-- Generated from website/src/content/docs/custom-components/custom-views.md by scripts/sync-agent-docs.ts. -->

# Customize list and edit views
...
[field component](./field-components.md) to work with those values, or a
[document tab](./document-views.md) to display saved document data.
