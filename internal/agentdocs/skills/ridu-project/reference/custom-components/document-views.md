<!-- Generated from website/src/content/docs/custom-components/document-views.md by scripts/sync-agent-docs.ts. -->
...
Use the [generated SDK](../typescript-sdk.md) if your tab performs an application operation.
...
To change the Edit screen itself, see [List and edit views](./custom-views.md).
To add a button alongside document actions, see [Document buttons](./document-actions.md).
