<!-- Generated from website/src/content/docs/mcp.md by scripts/sync-agent-docs.ts. -->
...
See the [`plugins/mcp` API reference](https://riducms.com/reference/mcp/) for the exact exported configuration types.
