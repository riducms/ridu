...
See [CORS](https://riducms.com/docs/cors/) for exact origins, credentials, custom headers, proxy trust, and preflight
...
Preview tokens are resource-bound credentials, not general API keys. See [Live preview](./live-preview.md)
...
automatically. See [Custom endpoints](https://riducms.com/docs/custom-endpoints/) for mounting, path parameters,
...
[`graphql`](https://riducms.com/reference/graphql/), for its available routes.
...
[protocol reference](https://riducms.com/reference/protocol/) lists the shared envelopes and stable error-code union;
the [SDK reference](https://riducms.com/reference/sdk/) lists the typed Fetch methods. Prefer the
[TypeScript SDK](./typescript-sdk.md) when TypeScript is available—it performs query encoding and
