---
title: 'Core concepts'
description: 'See how Go configuration becomes database schema, APIs, generated types, and the admin.'
product: core
eyebrow: 'Core'
order: 30
navigation:
...
and secrets are not serialized into the manifest. See [Configuration](/docs/configuration/) for the
complete surface.
...
Continue with [Generated contracts](/docs/generated-contracts/) and the
...
Read [Data access](/docs/data-access/), [Access control](/docs/access-control/), and
[Hooks](/docs/hooks/) when you need the detailed phase behaviour.

## 5. Choose a database and build {#adapters}

The [PostgreSQL](/docs/postgres/), [SQLite](/docs/sqlite/), and [MongoDB](/docs/mongodb/) adapters
...
the narrower supported production profile. An [object-storage adapter](/docs/storage/) stores upload
bytes. [Plugins](/docs/plugins/) add compiled Go capabilities and statically registered admin
capabilities.
...
Next, model a collection in [Fields](/docs/fields/), or read [Testing](/docs/testing/).
