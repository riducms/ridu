---
title: 'Global hooks'
description: 'Run hooks when reading or updating a single shared document, such as site settings or navigation.'
product: core
eyebrow: 'Hooks'
order: 82
navigation:
...
Globals use [`ridu.CollectionHooks`](/reference/ridu/collection-hooks/) and
[`ridu.HookContext`](/reference/ridu/hook-context/), the same types as collection hooks. You can
...
Create the [`recordLastEditor` helper](/docs/hooks/collections/#derive-values) in
...
The [save order](/docs/hooks/collections/#save-order) is the same as a collection update, with
...
API, and error information work as described in [Hook context](/docs/hooks/context/).
...
Follow [Transactions and errors](/docs/hooks/transactions-and-errors/) to share a transaction,
