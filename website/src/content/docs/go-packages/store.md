---
title: 'Documents and values'
description: 'Build Go document data, read field values safely, and save changes through the local API.'
product: core
eyebrow: 'Go packages'
order: 39
relatedSymbolIds:
  - 'go:github.com/riducms/ridu/store#Value'
  - 'go:github.com/riducms/ridu/store#Values'
  - 'go:github.com/riducms/ridu/store#Document'
  - 'go:github.com/riducms/ridu/store#String'
  - 'go:github.com/riducms/ridu/store#Object'
  - 'go:github.com/riducms/ridu/store#List'
  - 'go:github.com/riducms/ridu/store#Null'
aliases:
  [
    'store.Value',
    'store.Values',
...
and null. See [missing callback input](/docs/fields/callback-values/#missing-input).
...
It is not the package for constructing document values. See [Uploads](/docs/uploads/) for files.
...
selection or access rules. [Array fields](/docs/fields/array/) and
[Blocks](/docs/fields/blocks/) explain their update and localization rules.
...
[generated typed handles](/docs/local-api/#typed-handles) for binding and input examples.

For allocation-sensitive callbacks, [Hook and value performance](/docs/performance/hooks-and-values/)
