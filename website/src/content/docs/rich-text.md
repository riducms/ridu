---
title: 'Rich text'
description: 'Author portable Lexical documents with bounded validation, embedded references, and safe server-side HTML rendering.'
product: plugins
eyebrow: 'Plugins'
order: 190
aliases: ['Lexical', 'WYSIWYG', 'editor', 'portable text', 'RenderHTML', 'rich text blocks']
capabilities: ['plugin.rich-text']
availability:
  status: limited
  label: 'Default editor surface available'
  description: 'Links, formatting, lists, code, horizontal rules, uploads, relationships, validation, and HTML rendering work; tables, custom block authoring, Markdown/HTML import, collaboration, and a public Svelte renderer are not included.'
  anchor: frontend
navigation:
  section: 'Extend Ridu'
  parent: 'plugins'
...
![The official Ridu rich-text field in a Post editor with portable Lexical content and the surrounding schema-driven form.](../../../../docs/assets/ridu-admin-rich-text.png)
