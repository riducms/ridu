...
description: 'Use collections for posts and products, globals for site settings, and add the features each needs.'
product: core
...
See [Fields](/docs/fields/) for examples. A field name becomes a stored property and appears in
...
[documented production setup](/docs/mongodb/). If you write your own adapter, it must implement
