---
title: 'SQLite'
description: 'Run Ridu with its official embedded store inside the supported single-host operating envelope.'
product: adapters
eyebrow: 'Adapters'
order: 185
capabilities: ['adapter.sqlite']
navigation:
...
a distributed-database or high-availability contract. Choose [PostgreSQL](/docs/postgres/) when the
