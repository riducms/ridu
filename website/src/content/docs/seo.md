---
title: 'SEO'
description: 'Add localized search metadata, draft-aware generators, upload selection, and a live result preview to collections and globals.'
product: plugins
eyebrow: 'Plugins'
order: 195
aliases:
...
availability:
  status: available
  label: 'Paired authoring plugin'
  description: 'Overview checks, localized title, description and image fields, search preview, field overrides, collections, globals, tabbed layout, and optional generators are available.'
navigation:
  section: 'Extend Ridu'
  parent: 'plugins'
  order: 20
...
See the [`seo` Go reference](/reference/seo/),
[`@riducms/plugin-seo` reference](/reference/plugin-seo/), [Plugin system](/docs/plugins/),
[Localization](/docs/localization/), [Uploads](/docs/uploads/), and
