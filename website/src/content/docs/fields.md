---
title: 'Fields'
description: 'Define document fields, choose their inputs, and add validation, permissions, and custom behavior.'
product: core
...
![A clean overview of representative Ridu field controls: text, select, array, relationship, tabs, and rich text.](../../../../docs/assets/ridu-admin-field-showcase.png)
...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| Basic fields           | [Text](/docs/fields/text/), [Textarea](/docs/fields/textarea/), [Email](/docs/fields/email/), [Code](/docs/fields/code/), [Date](/docs/fields/date/), [Number](/docs/fields/number/), [Checkbox](/docs/fields/checkbox/), [Select](/docs/fields/select/), [Radio](/docs/fields/radio/), [Slug](/docs/fields/slug/) | Text, numbers, true/false values, and fixed choices                        |
| Structured             | [JSON](/docs/fields/json/), [Point](/docs/fields/point/), [Group](/docs/fields/group/), [Array](/docs/fields/array/), [Blocks](/docs/fields/blocks/), [Tabs](/docs/fields/tabs/)                                                                                                                                   | JSON values, objects, repeated rows, and rows with different field layouts |
| Relationship and media | [Relationship](/docs/fields/relationship/), [Upload](/docs/fields/upload/)                                                                                                                                                                                                                                         | Links to other documents or uploaded files                                 |
| Layout                 | [Row](/docs/fields/row/), [Collapsible](/docs/fields/collapsible/), [UI](/docs/fields/ui/)                                                                                                                                                                                                                         | Organize the form without adding stored properties                         |
| Computed and plugin    | [Join](/docs/fields/join/), [Virtual](/docs/fields/virtual/), [Plugin](/docs/fields/plugin/)                                                                                                                                                                                                                       | Computed values or a custom field type                                     |
...
See [Text and number lists](/docs/fields/lists/) for empty/null values, callbacks, and queries.
...
until an author supplies a manual value. Read [Slug](/docs/fields/slug/) for ASCII
...
The [Field components tutorial](/docs/custom-components/field-components/) shows the complete
...
- Use [Row labels](/docs/custom-components/row-labels/) to show a useful summary on an array or
  block row.
- Use [Table cells](/docs/custom-components/list-cells/) to change how a saved value appears in
  a collection list.
- Build a [field plugin](/guides/custom-fields/) when you need a new data format, server
...
For other admin changes, start with [Custom components](/docs/custom-components/).
...
prefill unsaved forms. See [Set default field values](/docs/fields/defaults/) for examples and
...
[Custom validation guide](/docs/fields/validation/) shows a complete URL validator, explains
...
[Live server validation](/docs/fields/live-validation/) explains when checks run and how to share
...
[Put a message on a child field](/docs/fields/validation/#validation-issue-targets) for group,
...
Start with [Using other field values](/docs/fields/callback-values/), which shows how to prevent
...
a response is being prepared. See [Which values does a callback see?](/docs/fields/callback-values/#callback-phases)
...
See [Identify the request and signed-in user](/docs/fields/callback-values/#callback-identity)
...
[Work with translations](/docs/fields/callback-values/#callback-locales) for single-locale
...
[Look up a related document](/docs/fields/callback-values/#callback-reader).

## Nested fields {#nested-fields}

Use [Group](/docs/fields/group/) for one known object, [Array](/docs/fields/array/) for ordered rows
with the same fields, and [Blocks](/docs/fields/blocks/) for rows with different layouts. Named
[Tabs](/docs/fields/tabs/) also create an object; unnamed tabs affect only presentation.
...
Use [Relationship](/docs/fields/relationship/) to select one or more documents, such as a post's
category. Use [Upload](/docs/fields/upload/) to select a file from a media collection. Ridu checks
...
documents too. A [Join](/docs/fields/join/) finds documents that point back to this one, such as
all posts in a category, without making you maintain a second list of IDs.

See [Relationships](/docs/relationships/) for filtering, related-document queries, and deletion rules.
...
The official [Rich-text plugin](/docs/rich-text/) provides formatted text, links, images, and
...
content. See [Content localization](/docs/localization/) and
[Admin language](/docs/admin-localization/).
...
[Customize a reusable group](/docs/fields/group/#reusable-groups) for more examples.
...
See [Migrations](/docs/migrations/) for the workflow.
...
and the [`field` API reference](/reference/field/) for every option.
