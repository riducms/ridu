---
title: 'Fields'
description: 'Choose a field by the value you need to store and the authoring control you want.'
product: core
...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------ |
| Scalar and choice      | [Text](/docs/fields/text/), [Textarea](/docs/fields/textarea/), [Email](/docs/fields/email/), [Code](/docs/fields/code/), [Date](/docs/fields/date/), [Number](/docs/fields/number/), [Checkbox](/docs/fields/checkbox/), [Select](/docs/fields/select/), [Radio](/docs/fields/radio/), [Slug](/docs/fields/slug/) | Strings, numbers, booleans, and finite choices               |
| Structured             | [JSON](/docs/fields/json/), [Point](/docs/fields/point/), [Group](/docs/fields/group/), [Array](/docs/fields/array/), [Blocks](/docs/fields/blocks/), [Tabs](/docs/fields/tabs/)                                                                                                                                   | JSON values, objects, repeated rows, and discriminated lists |
| Relationship and media | [Relationship](/docs/fields/relationship/), [Upload](/docs/fields/upload/)                                                                                                                                                                                                                                         | Stable document references or populated documents            |
| Layout                 | [Row](/docs/fields/row/), [Collapsible](/docs/fields/collapsible/), [UI](/docs/fields/ui/)                                                                                                                                                                                                                         | No stored property; these organise the editor                |
| Computed and plugin    | [Join](/docs/fields/join/), [Virtual](/docs/fields/virtual/), [Plugin](/docs/fields/plugin/)                                                                                                                                                                                                                       | Response-only output or a compiled plugin contract           |
...
Use a [UI field](/docs/fields/ui/) for presentation that stores no value. Use a
[Plugin field](/docs/fields/plugin/) and the complete [custom-field guide](/guides/custom-fields/)
...
rules in hooks, or create a typed [Plugin field](/docs/fields/plugin/) with a server validator.
...
Values use Ridu's typed [`store.Value`](/reference/store/value/) vocabulary. For example,
...
See [Conditional fields](/docs/fields/conditional-fields/) for `field.Sibling` paths, operators,
and compound presentation rules; [Virtual fields](/docs/fields/virtual/#sibling-data) for deriving
response values; and [field access](/docs/access-control/#sibling-data) for row-scoped
...
with one shape, and [Blocks](/docs/fields/blocks/) for an ordered union. Named
...
[Relationship](/docs/fields/relationship/) stores one/many references to one or several collection
targets. [Upload](/docs/fields/upload/) is the focused reference to one upload-enabled collection.
...
Use [Join](/docs/fields/join/) for an inverse view rather than keeping two ID lists synchronized.
See [Relationships, joins, and population](/docs/relationships/) for cardinality, delete behavior,
...
[Rich-text plugin](/docs/rich-text/) uses a Plugin field with a portable versioned document,
...
Join and [Virtual](/docs/fields/virtual/) values appear in generated output but never mutation
...
[Content localization](/docs/localization/).
...
and the [`field` API reference](/reference/field/) for signatures.
