---
title: 'PostgreSQL'
description: 'Configure, operate, and test Ridu’s official transactional store.'
product: adapters
eyebrow: 'Adapters'
order: 180
capabilities: ['adapter.postgres']
navigation:
...
REST or SDK paths your application depends on. Review [Testing](/docs/testing/),
[Releases and compatibility](/docs/releases/), and [Security](/docs/security/) for the wider checks.
