---
title: 'Form Builder'
description: 'Let editors assemble reusable forms, validate and persist submissions, send templated emails, accept uploads, and connect payment callbacks.'
product: plugins
eyebrow: 'Plugins'
order: 196
...
availability:
  status: available
  label: 'Paired workflow plugin'
  description: 'Reusable form definitions, public submissions, server validation, confirmations, redirects, emails, uploads, payments, overrides, generated contracts, and custom rendering are available.'
navigation:
  section: 'Extend Ridu'
  parent: 'plugins'
  order: 30
...
See the exact exported contracts in the [`formbuilder` Go reference](/reference/formbuilder/) and
[`@riducms/plugin-form-builder` reference](/reference/plugin-form-builder/).
