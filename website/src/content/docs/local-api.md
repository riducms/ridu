...
[Documents and values](/docs/go-packages/store/) explains these constructors, reading their
...
[field query-access contract](/docs/access-control/#field-access). A configured Read rule on
