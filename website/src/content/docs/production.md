...
`dist/`. Build with the Go and Bun versions listed in [Releases and compatibility](/docs/releases/)
...
use per replica; the [performance baseline](/docs/performance/) is not capacity planning for your
schema.
