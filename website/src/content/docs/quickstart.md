---
title: 'Quickstart'
description: 'Create a Ridu project with SQLite or PostgreSQL, save your first document, and read it with the generated TypeScript SDK.'
product: core
eyebrow: 'Get started'
order: 10
aliases:
...
capabilities: ['admin.authoring', 'data.rest-sdk', 'adapter.sqlite', 'adapter.postgres']
navigation:
  section: 'Get started'
  order: 10
  title: 'Quickstart'
...
![The Ridu admin dashboard showing the Users and Posts collections.](../../../../docs/assets/ridu-admin-dashboard.png)
...
the [PostgreSQL guide](/docs/postgres/#existing-project).

Next, learn [how a Ridu project is organised](/guides/project-structure/), choose the right
[field](/docs/fields/), or read the [TypeScript SDK guide](/docs/typescript-sdk/). See
[Installation](/docs/installation/) for other templates, existing services, and recovery.
