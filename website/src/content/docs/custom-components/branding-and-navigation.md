---
title: 'Branding and navigation'
description: 'Change the admin logo, add a navigation link, and place a message on the login screen.'
product: admin
order: 159
...
[Custom pages](/docs/custom-components/custom-pages/) to add a new admin page and its navigation link.
...
See the [admin configuration reference](/reference/plugin/admin-config/) for these
options and their component prop types. For shared settings across several of your components,
see [Shared settings](/docs/custom-components/providers/).
