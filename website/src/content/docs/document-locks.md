---
title: 'Coordinate editors with document locks'
description: 'Enable expiring edit leases, control takeover access, and keep optimistic revisions as the final write fence.'
product: admin
eyebrow: 'Admin tasks'
order: 125
aliases:
