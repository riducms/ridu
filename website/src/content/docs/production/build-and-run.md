---
title: 'Build and run'
description: 'Create a production binary, apply migrations, and start the result locally or on a server.'
product: core
eyebrow: 'Production'
order: 221
navigation:
...
Continue with the [Railway guide](/docs/production/railway/) for a concrete hosted deployment, or
the [production overview](/docs/production/) for security, health checks, backups, and rollout
rules.
